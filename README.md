# Algoritmos_IA_Modificados
Se utlizaron algoritmos de IA para darles un uso especifico para la vida cotidiana.
...
- PR2
Instalar: pip install -r .\PR2\chat_km\requirements.txt
cd .\PR2\chat_km\
uvicorn main:app --reload
ctr + c - Apagar/parar el chat